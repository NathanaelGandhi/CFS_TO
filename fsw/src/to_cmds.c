...
void TO_NoopCmd(const CFE_SB_Buffer_t *pCmdMsg)
{
    if (TO_VerifyCmdLength(pCmdMsg, sizeof(TO_NoArgCmd_t)))
    {
        ...
        CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "No-op command. Version %d.%d.%d.%d",
                          TO_MAJOR_VERSION, TO_MINOR_VERSION, TO_REVISION, TO_MISSION_REV);
    }
}
...
void TO_ResetCmd(const CFE_SB_Buffer_t *pCmdMsg)
{
    if (TO_VerifyCmdLength(pCmdMsg, sizeof(TO_NoArgCmd_t)))
    {
        ...
        CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "Recvd RESET cmd (%d)", TO_RESET_CC);
    }
}
...
void TO_EnableOutputCmd(const CFE_SB_Buffer_t *pCmdMsg)
{
    ...
    {
        g_TO_AppData.HkTlm.usCmdCnt++;
        CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "Recvd ENABLE_OUTPUT cmd (%d)",
                          TO_ENABLE_OUTPUT_CC);
        ...
        */
        ...
        else if (routeMask >= 0)
        {
            ...
            for (ii = 0; ii < TO_MAX_NUM_ROUTES; ++ii)
            {
                if (routeMask & (1 << ii))
                {
                    if (!g_TO_AppData.routes[ii].usExists || !g_TO_AppData.routes[ii].usIsConfig)
                    {
                        g_TO_AppData.HkTlm.usCmdErrCnt++;
                        CFE_EVS_SendEvent(TO_CMD_ERR_EID, CFE_EVS_EventType_ERROR,
            ...
            CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION,
                              "ENABLE OUTPUT CMD Succesful for Routes:0x%04x", routeMask);
        }
        else
        {
            g_TO_AppData.HkTlm.usCmdErrCnt++;
            CFE_EVS_SendEvent(TO_CMD_ERR_EID, CFE_EVS_EventType_ERROR, " ENABLE OUTPUT CMD failed.");
        }
    }
...
void TO_DisableOutputCmd(const CFE_SB_Buffer_t *pCmdMsg)
{
    ...
    {
        g_TO_AppData.HkTlm.usCmdCnt++;
        CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "Recvd DISABLE_OUTPUT cmd (%d)",
        ...
        {
            CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "DISABLE_OUTPUT CMD Succesful.");
        }
        ...
        else if (iStatus > 0)
        {
            ...
            CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION,
                              "DISABLE_OUTPUT CMD Successful for Routes:0x%04x", routeMask);
        }
        else
        {
...
void TO_ActivateRoutesCmd(const CFE_SB_Buffer_t *pCmdMsg)
{
    ...
    {
        g_TO_AppData.HkTlm.usCmdCnt++;
        CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "Recvd ACTIVATE_ROUTES cmd (%d)",
        ...
        for (ii = 0; ii < TO_MAX_NUM_ROUTES; ++ii)
        {
            if (cmd->usRouteMask & (1 << ii))
            {
                ...
                {
                    CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "Route ID:%u is already enabled.",
                                      ii);
                }
        ...
        CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "Routes 0x%04x succesfully enabled.",
                          cmd->usRouteMask);
    }
...
void TO_DeactivateRoutesCmd(const CFE_SB_Buffer_t *pCmdMsg)
{
    ...
    {
        g_TO_AppData.HkTlm.usCmdCnt++;
        CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "Recvd DEACTIVATE_ROUTES cmd (%d)",
        ...
        CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "Routes 0x%04x succesfully disabled.",
                          cmd->usRouteMask);
    }
...
void TO_PauseOutputCmd(const CFE_SB_Buffer_t *pCmdMsg)
{
    ...
    {
        g_TO_AppData.HkTlm.usCmdCnt++;
        CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "Recvd PAUSE_OUTPUT cmd (%d)",
                          TO_PAUSE_OUTPUT_CC);
        ...
        CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "PAUSE_OUTPUT CMD Succesful.");
    }
...
void TO_ResumeOutputCmd(const CFE_SB_Buffer_t *pCmdMsg)
{
    ...
    {
        g_TO_AppData.HkTlm.usCmdCnt++;
        CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "Recvd RESUME_OUTPUT cmd (%d)",
                          TO_RESUME_OUTPUT_CC);
        ...
        g_TO_AppData.usOutputActive = 1;
        CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "RESUME_OUTPUT CMD Succesful.");
    }
...
void TO_AddTblEntryCmd(const CFE_SB_Buffer_t *pCmdMsg)
{
    ...
    {
        g_TO_AppData.HkTlm.usCmdCnt++;
        CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "Recvd ADD_TBL_ENTRY cmd (%d)",
                          TO_ADD_TBL_ENTRY_CC);
        ...
        /* Validate MID */
        if (pCmd->usMsgId == TO_REMOVED_ENTRY || pCmd->usMsgId == TO_UNUSED_ENTRY)
        {
            g_TO_AppData.HkTlm.usCmdErrCnt++;
            CFE_EVS_SendEvent(TO_CMD_ERR_EID, CFE_EVS_EventType_ERROR,
        ...
        else
        {
            ...
            {
                g_TO_AppData.HkTlm.usCmdErrCnt++;
                CFE_EVS_SendEvent(TO_CMD_ERR_EID, CFE_EVS_EventType_ERROR, "TO_ADD_TBL_ENTRY CMD failed. %d",
                                  pCmd->usMsgId);
                /* Reset entry */
                pEntry->usMsgId         = 0;
            ...
            CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION,
                              ...
                              index, pEntry->usMsgId, pEntry->usRouteMask, pEntry->usMsgLimit, pEntry->uiGroupData,
                              pEntry->usState);
        }
    }
...
void TO_RemoveTblEntryCmd(const CFE_SB_Buffer_t *pCmdMsg)
{
    ...
    {
        g_TO_AppData.HkTlm.usCmdCnt++;
        CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "Recvd REMOVE_TBL_ENTRY cmd (%d)",
        ...
        {
            g_TO_AppData.HkTlm.usCmdErrCnt++;
            CFE_EVS_SendEvent(TO_CMD_ERR_EID, CFE_EVS_EventType_ERROR, "TO_REMOVE_TBL_ENTRY CMD failed.");
            goto end_of_command;
        }
...
void TO_EnableTblEntryCmd(const CFE_SB_Buffer_t *pCmdMsg)
{
    ...
    {
        g_TO_AppData.HkTlm.usCmdCnt++;
        CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "Recvd ENABLE_TBL_ENTRY cmd (%d)",
        ...
        CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "Succesfully Enabled TBL entry:%u, MID:0x%04x",
                          index, pCmd->usMsgId);
    }
...
void TO_DisableTblEntryCmd(const CFE_SB_Buffer_t *pCmdMsg)
{
    ...
    {
        g_TO_AppData.HkTlm.usCmdCnt++;
        CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "Recvd DISABLE_TBL_ENTRY cmd (%d)",
        ...
        CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION,
                          "Succesfully Disabled TBL entry:%u, MID:0x%04x", index, pCmd->usMsgId);
    }
...
void TO_EnableGroupCmd(const CFE_SB_Buffer_t *pCmdMsg)
{
    ...
    {
        g_TO_AppData.HkTlm.usCmdCnt++;
        CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "Recvd ENABLE_GROUP cmd (%d)",
                          TO_ENABLE_GROUP_CC);
        ...
        {
            CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION,
                              "ENABLE GROUP CMD Successful. GroupData:0x%08x", pCmd->uiGroupData);
        }
    }
}
...
void TO_DisableGroupCmd(const CFE_SB_Buffer_t *pCmdMsg)
{
    ...
    {
        g_TO_AppData.HkTlm.usCmdCnt++;
        CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "Recvd DISABLE_GROUP cmd (%d)",
                          TO_DISABLE_GROUP_CC);
        ...
        {
            CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION,
                              "DISABLE GROUP CMD Successful. GroupData:0x%08x", pCmd->uiGroupData);
        }
    }
}
...
void TO_EnableAllCmd(const CFE_SB_Buffer_t *pCmdMsg)
{
    ...
    {
        g_TO_AppData.HkTlm.usCmdCnt++;
        CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "Recvd ENABLE ALL cmd (%d)", TO_ENABLE_ALL_CC);
        ...
        {
            CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "All Entries enabled.");
        }
    }
}
...
void TO_DisableAllCmd(const CFE_SB_Buffer_t *pCmdMsg)
{
    ...
    {
        g_TO_AppData.HkTlm.usCmdCnt++;
        CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "Recvd DISABLE ALL cmd (%d)",
                          TO_DISABLE_ALL_CC);
        ...
        {
            CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "All Entries disabled.");
        }
    }
}
...
void TO_SetRouteByMidCmd(const CFE_SB_Buffer_t *pCmdMsg)
{
    ...
    {
        g_TO_AppData.HkTlm.usCmdCnt++;
        CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "Recvd SET_ROUTE_BY_MID cmd (%d)",
...
void TO_SetRouteByGroupCmd(const CFE_SB_Buffer_t *pCmdMsg)
{
    ...
    {
        g_TO_AppData.HkTlm.usCmdCnt++;
        CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "Recvd SET_ROUTE_BY_GROUP cmd (%d)",
...
void TO_ManageTableCmd(const CFE_SB_Buffer_t *pCmdMsg)
{
    ...
    {
        g_TO_AppData.HkTlm.usCmdCnt++;
        CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "Recvd MANAGE TABLE CMD (%d)",
                          TO_MANAGE_TABLE_CC);

        /* Temporarily save the previous table */
        memcpy((void *)&oldTable, (void *)g_TO_AppData.pConfigTable, sizeof(TO_ConfigTable_t));
        ...
        if (iStatus != CFE_SUCCESS && iStatus != CFE_TBL_INFO_UPDATED)
        {
            ...
            g_TO_AppData.HkTlm.usTblErrCnt++;
            CFE_EVS_SendEvent(TO_TBL_ERR_EID, CFE_EVS_EventType_ERROR,
                              "CFE_TBL_Manage() returned error 0x%08x.  TO_ManageTable failed.", iStatus);
        ...
        iStatus = CFE_TBL_GetAddress((void **)&pTable, g_TO_AppData.tableHandle);
        ...
        if (iStatus == CFE_TBL_INFO_UPDATED)
        {
            ...
            if (iStatus != CFE_SUCCESS)
            {
                ...
                memcpy((void *)pTable, (void *)&oldTable, sizeof(TO_ConfigTable_t));
            ...
            CFE_EVS_SendEvent(TO_TBL_INF_EID, CFE_EVS_EventType_INFORMATION, "ConfigTable updated succesfully. ");
        }
        else if (iStatus == CFE_SUCCESS)
        {
            ...
            CFE_EVS_SendEvent(TO_TBL_INF_EID, CFE_EVS_EventType_INFORMATION, "ConfigTable did not change.");
        }
        else
        {
            g_TO_AppData.HkTlm.usCmdErrCnt++;
...
void TO_SetRoutePeriodCmd(const CFE_SB_Buffer_t *pCmdMsg)
{
    ...
    {
        g_TO_AppData.HkTlm.usCmdCnt++;
        CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "Recvd SET_ROUTE_PERIOD cmd (%d)",
...
void TO_SetWakeupTimeoutCmd(const CFE_SB_Buffer_t *pCmdMsg)
{
    ...
    {
        g_TO_AppData.HkTlm.usCmdCnt++;
        CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "Recvd SET_WAKEUP_TIMEOUT cmd (%d)",
                          TO_SET_ROUTE_PERIOD_CC);

        /* Validate input timeout value */
        if (pCmd->uiWakeupTimeout != CFE_SB_PEND_FOREVER && pCmd->uiWakeupTimeout < TO_MIN_WAKEUP_TIMEOUT)
        {
            g_TO_AppData.HkTlm.usCmdErrCnt++;
            CFE_EVS_SendEvent(TO_CMD_ERR_EID, CFE_EVS_EventType_ERROR,
...
void TO_SendDataTypePktCmd(const CFE_SB_Buffer_t *pCmdMsg)
{
    ...
    {
        g_TO_AppData.HkTlm.usCmdCnt++;
        CFE_EVS_SendEvent(TO_CMD_INF_EID, CFE_EVS_EventType_INFORMATION, "TO - Recvd SEND_DATA_TYPE cmd (%d)",
                          TO_SEND_DATA_TYPE_CC);

        /* initialize data types packet */
        CFE_MSG_Init(&testPacket.TlmHeader.Msg, TO_DATA_TYPE_MID, sizeof(testPacket));
